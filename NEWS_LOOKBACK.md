...
- **Josh Downs is off by a day.** The bench entry reads 2026-08-08 for the groin injury; the blinded search found 2026-08-09 for a second straight missed session. Same injury, different day of the same story. It is inside the window either way, and it sits on the `date_confirmed_on_source: unknown` audit list.
